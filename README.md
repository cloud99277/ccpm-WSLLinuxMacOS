...
CCPM (Claude Code Profile Manager) 是一个为 WSL/Linux/macOS 用户打造的自动化管理脚本。
...
node -v
npm -v
如果没有显示版本号：请先去 Node.js 官网 下载安装（推荐安装 LTS 版本）。
...
2. MiniMax (海螺)
Base URL: https://api.minimaxi.com/anthropic--------国际版使用https://api.minimax.io/anthropic
